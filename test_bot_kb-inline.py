...
async def news(callback: CallbackQuery):
   await callback.answer("Catalog подгружается", show_alert=True)
   await callback.message.answer('Вот последний каталог!')
...
async def start(message: Message):
        await message.answer(f'Hello!, {message.from_user.first_name}', reply_markup=inline_keyboard_test)
